...
data class Event(
    ...
    companion object {
        const val TABLE_EVENT_FAVORITES: String = "FAVORITE_EVENTS"
        ...
        const val EVENT_HOME_YELLOW_CARDS: String = "EVENT_HOME_YELLOW_CARDS"
        const val EVENT_AWAY_YELLOW_CARDS: String = "EVENT_AWAY_YELLOW_CARDS"
        const val EVENT_HOME_RED_CARDS: String = "EVENT_HOME_RED_CARDS"
        const val EVENT_AWAY_RED_CARDS: String = "EVENT_AWAY_RED_CARDS"
    }
}